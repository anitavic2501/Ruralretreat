...
class admin extends user {
    ...
    public function update_user(){
        if (isset($_POST['username']) && isset($_POST['userfname']) && isset($_POST['userlname']) && isset($_POST['contact_number']) && isset($_POST['email'])) {
            ...
            if (!empty($new_user_id)) {
                ...
                if (!empty($result)) {
                    $total = $this->DB->update("users", array('username' => $username, 'userfname' => $fname, 'userlname' => $lname, 'email' => $email, 'contact_number' => $contact_number), $new_user_id);
    ...
    public function update_car() {
     ...
     //   $image = $this->uploadimage('image');
        ...
        if (!empty($car_id)) {
            ...
            if (!empty($result)) {
                $total = $this->DB->update_car("cars", array('model' => $model, 'car_year' => $car_year, 'price_per_day' => $price, 'brand' => $brand),$car_id);
