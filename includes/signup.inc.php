...
if (isset($_POST['signup-submit'])) {
  ...
  echo "<script> alert('Invalid Email and username!!');window.location='../signup.php'</script>";
         exit();
  }
  ...
  // We check for an invalid username. In this case ONLY letters and numbers.
   ...
   echo "<script> alert('Invalid username!!');window.location='../signup.php?email=".$email."'</script>";
         exit();
  }
  ...
  // We check if the repeated password is NOT the same.
   ...
   echo "<script> alert('Error on your database!!');window.location='../signup.php'</script>";
         exit();
  }
    else {
     ...
     header("Location: ../signup.php?error=usertaken"); 
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
          // If there is an error we send the user back to the signup page.
        echo "<script> alert('Error occured, Please try again!!');window.location='../signup.php'</script>";
         exit();
        }
        else {
